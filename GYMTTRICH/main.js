/**
 * Fitness Dashboard - Main Logic
 * Handles data loading, DOM manipulation, and Chart generation.
 */
...
async function loadData() {
    try {
        ...
        alert('Could not load data.json. Check console.');
    }
}
...
function setupSettings() {
    ...
    // Simulate Save (Update App State)
    saveBtn.addEventListener('click', () => {
        try {
            const newData = JSON.parse(editor.value);
            appData = newData;
            renderAll();
            alert('Settings updated in memory! (Reloading page will reset unless you replace data.json)');
        } catch (e) {
