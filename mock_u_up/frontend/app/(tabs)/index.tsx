...
export default function DashboardScreen() {
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Animated.View entering={FadeInDown.delay(400).duration(500)} style={styles.progressContainer}>
        ...
        <Card style={styles.chartCardWrapper}>
          ...
          <LineChart
            data={{
              ...
              datasets: [{ data: [72, 72.5, 73, 73.8, 74.5, 75], color: (opacity = 1) => `rgba(38, 198, 218, ${opacity})` }]
            }}
...
const styles = StyleSheet.create({
  ...
  statsGrid: { flexDirection: 'column', gap: 16, marginBottom: 32 },
  cardWrapper: { marginBottom: 8 },
  progressContainer: { marginBottom: 16 },
  chartCardWrapper: { marginTop: 16 },
